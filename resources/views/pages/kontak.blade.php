...
@section('meta_description', 'Hubungi SDN Ketawang Karay untuk informasi lebih lanjut tentang sekolah, pendaftaran, atau pertanyaan lainnya.')
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                {{ SettingHelper::get('site_address', 'Jl. Pendidikan No. 123, Ketawang Karay') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                {{ SettingHelper::get('site_phone', '(0271) 123-4567') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                {{ SettingHelper::get('site_email', 'info@sdnketawangkaray.sch.id') }}
                            </p>
                        </div>
                    </div>
                </div>
