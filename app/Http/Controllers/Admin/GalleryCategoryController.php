...
class GalleryCategoryController extends Controller
{
    ...
    {
        $categories = GalleryCategory::withCount('galleries')->latest()->paginate(15);
    ...
    public function destroy(GalleryCategory $galleryCategory)
    {
        if ($galleryCategory->galleries()->count() > 0) {
            return back()->with('error', 'Kategori galeri tidak dapat dihapus karena masih memiliki foto.');
        }
